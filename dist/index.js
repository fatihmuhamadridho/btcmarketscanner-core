...
__export(index_exports, {
  analyzeSetupSide: () => analyzeSetupSide,
  analyzeTrend: () => analyzeTrend,
  buildSetupPathStep: () => buildSetupPathStep,
  buildTakeProfitSteps: () => buildTakeProfitSteps,
  buildZone: () => buildZone,
  formatText: () => formatText,
  getAverageTrueRange: () => getAverageTrueRange,
  getBinanceFuturesApiLabel: () => getBinanceFuturesApiLabel,
  getBinanceFuturesBaseUrl: () => getBinanceFuturesBaseUrl,
  getExponentialMovingAverage: () => getExponentialMovingAverage,
  getGradeFromScore: () => getGradeFromScore,
  getRelativeStrengthIndex: () => getRelativeStrengthIndex,
  getSupportResistance: () => getSupportResistance,
  helloCore: () => helloCore
});
